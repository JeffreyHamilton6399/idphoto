...
function PrivacyBody() {
  return (
    <>
      ...
      <p>
        IDPhoto does not require sign-up and does not use accounts. It sets no
      ...
      <ul>
        <li>The files you choose to open.</li>
      ...
      <p>
        ...
        disk by IDPhoto itself beyond what you explicitly save.
      </p>

      <h3>Analytics</h3>
      <p>
        IDPhoto includes no third-party analytics and no advertising trackers.
      ...
      <p>
        IDPhoto is a general-purpose utility and does not knowingly collect
      ...
      <h3>Contact</h3>
      <p>
        IDPhoto is open source. For questions about this policy, email{" "}
        <a
...
function TermsBody() {
  return (
    <>
      <p>
        By using IDPhoto, you agree to these terms. They’re short on purpose.
      </p>
      ...
      <p>
        You are responsible for the files you use with the tool. Because the
      ...
      <ul>
        <li>Don’t use IDPhoto for anything you don’t have the right to do.</li>
      ...
      <p>IDPhoto is built on open-source libraries, including face-api.js and @imgly/background-removal. Each is governed by its own license.</p>

      <h3>Changes</h3>
      <p>
        These terms may be updated from time to time. Continued use of
        IDPhoto after a change constitutes acceptance of the updated terms.
      </p>
    </>
  );
}
